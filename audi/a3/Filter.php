...
require('Model/CarController.php');
 ...
 $content = "
      ...
      <div>
       <div class='tabbar'>
        <div class='tabs'>
              <a href='#' class='tab1' onclick='Selecttab(1);return false;'> Select by Brand</a>
      ...
      <div class='content_switcher ' id='content1'>
           ...
           <tr>
                <td>
                  ...
                  <div id='imgbox'><a href='bmw\bmw.html'><img src='images\bmw_logo.jpg'       alt='bmw'></a>
                     <br> BMW
                  </div>
           ...
           <table  border=0 cellpadding=2 cellspacing=5 bgcolor=#eeeeee align=center width=1000px>
                ...
                <tr>
                   <th>Please select Brand</th>
                       <td>".$carController->CreateCarBrandDropdown() ."</td>
                </tr>
